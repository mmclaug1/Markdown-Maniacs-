...
#Room A is the most reserved room, followed by room D and E. 
...
#Above is a breakdown of the room reservation requests in a ggplot graph.
...
```{r}
reserved_room_type <- as.factor(hotel$reserved_room_type)

assigned_room_type <- as.factor(hotel$assigned_room_type)
