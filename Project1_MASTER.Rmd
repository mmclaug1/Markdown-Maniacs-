...
We have discovered that the majority of repeat customers are employed in the aviation, corporate or complementary market segments. This makes sense as these individuals would frequently travel for business purposes.  
...
Complementary, Groups and corporate are the most likely to cancel a reservation. 
...
To conclude in this section we explored the habits of customers in different market segments, and how it relates to room requests, repeat business and cancellations. After determining the trends of each market segment, we explored how many room requests were fulfilled, and the cancellation rate of different customers. This information will help the hotel predict future demand, forecast capacity when booked out, and help match room to customer requests. 
