...
Here, we cleaned the data to turn a number of different variables in the data set into factors to make the data easier to work with. This is a test, hello world. 
